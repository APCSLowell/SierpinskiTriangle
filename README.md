...
5. You could also create a [Sierpinski carpet](http://en.wikipedia.org/wiki/Sierpinski_carpet), Wallis sieve, Hawaiian earring, Menger sponge or similiar as an alternative to the Sierpinski Triangle.
